...
const (
	wowUserPath                      = "/wow" + "/user"
	wowUserCharactersPath            = wowUserPath + "/characters"
	wowAuctionDataPath               = "/wow" + "/auction" + dataPath
	wowBossPath                      = "/wow" + "/boss"
	wowChallengePath                 = "/wow" + "/challenge"
	wowChallengeRegionPath           = wowChallengePath + "/region"
	wowCharacterPath                 = "/wow" + "/character"
	wowGuildPath                     = "/wow" + "/guild"
	wowItemPath                      = "/wow" + "/item"
	wowItemSetPath                   = wowItemPath + "/set"
	wowMountPath                     = "/wow" + "/mount"
	wowPetPath                       = "/wow" + "/pet"
	...
	wowPVPLeaderboardPath            = "/wow" + "/leaderboard"
	wowQuestPath                     = "/wow" + "/quest"
	wowRealmStatusPath               = "/wow" + "/realm/status"
	wowRecipePath                    = "/wow" + "/recipe"
	wowSpellPath                     = "/wow" + "/spell"
	wowZonePath                      = "/wow" + "/zone"
	wowDataPath                      = "/wow" + "/data"
...
func (c *Client) WoWUserCharacters(token *oauth2.Token) (*wowc.Profile, []byte, error) {
	...
	case http.StatusNotFound:
		return &dat, b, errors.New(res.Status)
	}
