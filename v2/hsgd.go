...
func (c *Client) HSCardsSearch(ctx context.Context) (*hsgd.CardSearch, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/cards?locale=%s", c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSCardByIDOrSlug(ctx context.Context, idOrSlug string, gameMode hsgd.GameMode) (*hsgd.Card, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/cards/%s?locale=%s&gameMode=%s", idOrSlug, c.locale, gameMode), "")
	if err != nil {
		return &dat, b, err
	}
...
// Input values left blank, 0, or nil will return all values for the type.
// For more information about the search parameters, see the Card Search Guide (https://develop.battle.net/documentation/hearthstone/guides/card-search).
func (c *Client) HSCardBackSearchAllLocales(ctx context.Context, cardBackCategory hsgd.CardBackCategory, textFilter string, sort hsgd.Sort, order hsgd.Order) (*hsgd.CardBackSearchAllLocales, []byte, error) {
	var (
...
// Input values left blank, 0, or nil will return all values for the type.
// For more information about the search parameters, see the Card Search Guide (https://develop.battle.net/documentation/hearthstone/guides/card-search).
func (c *Client) HSCardBackSearch(ctx context.Context, cardBackCategory hsgd.CardBackCategory, textFilter string, sort hsgd.Sort, order hsgd.Order) (*hsgd.CardBackSearch, []byte, error) {
	var (
...
func (c *Client) HSCardBackByIDOrSlug(ctx context.Context, idOrSlug string) (*hsgd.CardBack, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/cardbacks/%s?locale=%s", idOrSlug, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSDeck(ctx context.Context, deckCode string) (*hsgd.Deck, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/deck/%s?locale=%s", deckCode, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadata(ctx context.Context) (*hsgd.Metadata, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata?locale=%s", c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataSets(ctx context.Context) (*[]hsgd.Set, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeSets, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataSetGroups(ctx context.Context) (*[]hsgd.SetGroup, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeSetGroups, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataTypes(ctx context.Context) (*[]hsgd.Type, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeTypes, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataRarities(ctx context.Context) (*[]hsgd.Rarity, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeRarities, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataClasses(ctx context.Context) (*[]hsgd.Class, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeClasses, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataMinionTypes(ctx context.Context) (*[]hsgd.MinionType, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeMinionTypes, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) HSMetadataKeywords(ctx context.Context) (*[]hsgd.Keyword, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/hearthstone/metadata/%s?locale=%s", hsgd.MetadataTypeKeywords, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
