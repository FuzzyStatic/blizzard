...
func (c *Client) SC2StaticProfile(ctx context.Context, region Region) (*sc2c.StaticProfile, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/static/profile/%d?locale=%s", region, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2MetadataProfile(ctx context.Context, region Region, realmID, profileID int) (*sc2c.MetadataProfile, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/metadata/profile/%d/%d/%d?locale=%s", region, realmID, profileID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2Profile(ctx context.Context, region Region, realmID, profileID int) (*sc2c.Profile, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/profile/%d/%d/%d?locale=%s", region, realmID, profileID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2ProfileLadderSummary(ctx context.Context, region Region, realmID, profileID int) (*sc2c.LadderSummary, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/profile/%d/%d/%d/ladder/summary?locale=%s", region, realmID, profileID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2ProfileLadder(ctx context.Context, region Region, realmID, profileID, ladderID int) (*sc2c.Ladder, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/profile/%d/%d/%d/ladder/%d?locale=%s", region, realmID, profileID, ladderID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LadderGrandmaster(ctx context.Context, region Region) (*sc2c.LadderGrandmaster, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/ladder/grandmaster/%d?locale=%s", region, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LadderSeason(ctx context.Context, region Region) (*sc2c.LadderSeason, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/ladder/season/%d?locale=%s", region, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2Player(ctx context.Context, accountID int) (*sc2c.Player, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/player/%d?locale=%s", accountID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LegacyProfile(ctx context.Context, region Region, realmID, profileID int) (*sc2c.LegacyProfile, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/legacy/profile/%d/%d/%d?locale=%s", region, realmID, profileID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LegacyProfileLadders(ctx context.Context, region Region, realmID, profileID int) (*sc2c.LegacyProfileLadders, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/legacy/profile/%d/%d/%d/ladders?locale=%s", region, realmID, profileID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LegacyProfileMatches(ctx context.Context, region Region, realmID, profileID int) (*sc2c.LegacyProfileMatches, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/legacy/profile/%d/%d/%d/matches?locale=%s", region, realmID, profileID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LegacyLadder(ctx context.Context, region Region, ladderID int) (*sc2c.LegacyLadder, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/legacy/ladder/%d/%d?locale=%s", region, ladderID, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LegacyAchievements(ctx context.Context, region Region) (*sc2c.LegacyAchievements, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/legacy/data/achievements/%d?locale=%s", region, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
...
func (c *Client) SC2LegacyRewards(ctx context.Context, region Region) (*sc2c.LegacyRewards, []byte, error) {
	...
	b, err = c.getURLBody(ctx, c.apiURL+fmt.Sprintf("/sc2/legacy/data/rewards/%d?locale=%s", region, c.locale), "")
	if err != nil {
		return &dat, b, err
	}
