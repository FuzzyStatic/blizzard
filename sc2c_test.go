...
func TestSC2MetadataProfile(t *testing.T) {
	dat, _, err := c.SC2MetadataProfile(US, 1, 305084)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2Profile(t *testing.T) {
	dat, _, err := c.SC2Profile(US, 1, 305084)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2ProfileLadderSummary(t *testing.T) {
	dat, _, err := c.SC2ProfileLadderSummary(US, 1, 305084)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2ProfileLadder(t *testing.T) {
	dat, _, err := c.SC2ProfileLadder(US, 1, 2376042, 194163)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2LadderGrandmaster(t *testing.T) {
	dat, _, err := c.SC2LadderGrandmaster(EU)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2LadderSeason(t *testing.T) {
	dat, _, err := c.SC2LadderSeason(EU)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2LegacyLadder(t *testing.T) {
	dat, _, err := c.SC2LegacyLadder(US, 194163)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2LegacyAchievements(t *testing.T) {
	dat, _, err := c.SC2LegacyAchievements(US)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
...
func TestSC2LegacyRewards(t *testing.T) {
	dat, _, err := c.SC2LegacyRewards(US)
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
